...
options:
  ...
  tier:
    ...
    version_added: 1.5.0
seealso:
  - ref: amazon.aws.aws_ssm_parameter lookup <ansible_collections.amazon.aws.aws_ssm_lookup>
    description: The documentation for the C(amazon.aws.aws_ss) lookup plugin.
